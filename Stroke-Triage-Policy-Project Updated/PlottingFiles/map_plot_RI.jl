...
    # Define the latitude and longitude of the state of Rhode Island
    # Center of RI is basically 41.72249712781411, -71.55290124206866

    RhodeIsland_lat = 41.72249712781411
    RhodeIsland_lon = -71.55290124206866
    
    # Define the zoom level (adjust this as needed)
    zoom_level = 0.54  # You can adjust this value to zoom in or out

    # Calculate the region coordinates based on RhodeIsland's coordinates and zoom level
    region = [RhodeIsland_lon - zoom_level, RhodeIsland_lon + zoom_level, RhodeIsland_lat - zoom_level, RhodeIsland_lat + zoom_level]
...
        show=true,
        savefig="Figures/Optimal_RhodeIsland.pdf"
    )
    
end
...
    # Define the latitude and longitude of RhodeIsland
    RhodeIsland_lat = 41.72249712781411
    RhodeIsland_lon = -71.55290124206866
    
    # Define the zoom level (adjust this as needed)
    zoom_level = 1  # You can adjust this value to zoom in or out
...
        show=true,
        savefig="Figures/Status_Quo_RhodeIsland(CAstatusquoNOT_RI).pdf"
    ) 
end


hospital_csv = "HospitalInfo/hospital_list_RI.csv"
sims_csv = "SimResults/RI_1000points.csv"
