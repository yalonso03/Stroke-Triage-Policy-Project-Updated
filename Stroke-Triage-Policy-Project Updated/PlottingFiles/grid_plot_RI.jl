# File: grid_plot_RI.jl by Emily Molins and Yasmine Alonso for AA229
# -----------------------------------------------------------
...
# gridded-up version of the focus area (Rhode Island). To do so, we grid
...
    # Define the latitude and longitude of RhodeIsland, CA
    RhodeIsland_lat = 41.72249712781411
    RhodeIsland_lon = -71.55290124206866
    zoom_level = 0.55

    # Calculate the region coordinates
    my_region = [RhodeIsland_lon - zoom_level, RhodeIsland_lon + zoom_level, RhodeIsland_lat - zoom_level, RhodeIsland_lat + zoom_level]
...
    path = "Figures/" * option * "_hotspot_gridplot_testing_RI.pdf"
